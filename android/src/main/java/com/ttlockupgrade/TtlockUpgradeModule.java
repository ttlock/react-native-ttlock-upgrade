...
import com.ttlockupgrade.model.TTLockEvent;
import com.ttlockupgrade.model.TTUpgradeError;
import com.ttlockupgrade.model.TTUpgradeStatus;
import com.ttlockupgrade.util.PermissionUtils;
...
public class TtlockUpgradeModule extends ReactContextBaseJavaModule {
  ...
  @ReactMethod
  public void startGatewayDfuByFirmwarePackage(String firmwarePackage, String gatewayMac, Callback successCallback, Callback fail) {
    PermissionUtils.doWithScanPermission(getCurrentActivity(), success -> {
      if (success) {
